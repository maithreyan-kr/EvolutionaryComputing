...
def chc_genetic_algorithm(cities, population_size, generations):
...
if __name__ == "__main__":
    ...
    best_path, avg_objectives, max_objectives = chc_genetic_algorithm(cities, population_size, generations)
    
    best_fitness = total_distance(best_path, cities)
    print(f"Best Result: Path {best_path}, Fitness {best_fitness}")
        
    # plot
    plt.plot(avg_objectives, label='Average Objective')
    plt.plot(max_objectives, label='Max Objective')
